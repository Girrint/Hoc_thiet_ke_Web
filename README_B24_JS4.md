...
<body>
  <div class="calculator">
    ...
    <div class="calculator-keys">
      ...
      <button class="key key-operator" data-action="*">x</button>
...
.calculator {
    ...
    background-color: #334155;/\* Slate-700 \*/ box-shadow: 0 20px 25px \-5px rgba(0, 0, 0, 0.3), 0 10px 10px \-5px rgba(0, 0, 0, 0.1);
...
.calculator-display {
    ...
    background-color: #1e293b;/\* Slate-800 \*/ color: #f8fafc;/\* White \*/ font-size: 2.5rem;
...
.key {
    ...
    border-radius: 9999px;/\* Full rounded \*/ cursor: pointer;
...
/\* Nút Số (Digits) \*/ .key-digit,
.key-decimal {

    background-color: #475569;/\* Slate-600 \*/ color: #f8fafc;
...
/\* Nút Toán tử (Operators) \*/ .key-operator {

    background-color: #f97316;/\* Orange-600 \*/ color: #fff;
...
/\* Nút Đặc biệt (AC/Equals) \*/ .key-ac {

    background-color: #ef4444;/\* Red-500 \*/ color: #fff;
